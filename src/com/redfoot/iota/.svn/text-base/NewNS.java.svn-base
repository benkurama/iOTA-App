...
public class NewNS extends Activity implements OnItemClickListener {
 // =========================================================================
 // TODO Variables
 // =========================================================================
	...
	private static String NSMAP001 = "";
	private static String NSMAP002 = "";
	
	private MainApp m_maApp;
	private BroadcastReceiver m_brSMS;
	private ListView m_lvEstablishments;
	
	private EditText etGP;
	private EditText etTM;
	private TextView tvMobtel;
	private EditText etMobtel;
 // =========================================================================
 // TODO Life Cycles
 // =========================================================================
    @Override
    public void onCreate(Bundle savedInstanceState) {
        ...
        etGP = (EditText)this.findViewById(R.id.d_etAveSalesGP_Reload);
        etTM = (EditText)this.findViewById(R.id.d_etAveSalesTM_Reload);
        //tvMobtel = (TextView)this.findViewById(R.id.d_tvMobtel);
        etMobtel = (EditText)this.findViewById(R.id.d_etMobtel);
        ...
        etGP.addTextChangedListener(new TextWatcher() {
			...
			public void afterTextChanged(Editable s) {
				// TODO Auto-generated method stub
				String textChange = etGP.getEditableText().toString().trim();
				if(!textChange.matches("")){
					int temp = Integer.parseInt(textChange);
				
					if(temp > 0){
						tvMobtel.setText(getString(R.string.NDSOMobtel_Editable));
						etMobtel.setEnabled(true);
					} else {
						tvMobtel.setText(getString(R.string.NDSOMobtel));
						etMobtel.setText("");
						etMobtel.setEnabled(false);
					}
				} else {
					tvMobtel.setText(getString(R.string.NDSOMobtel));
					etMobtel.setText("");
        ...
        etTM.addTextChangedListener(new TextWatcher() {
			...
			public void afterTextChanged(Editable s) {
				// TODO Auto-generated method stub
				String textChange = etTM.getEditableText().toString().trim();
				if(!textChange.matches("")){
					int temp = Integer.parseInt(textChange);
			...
			case MainApp.DIALOG_IOTA_NUM_ID:
				...
				bOK.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						if (sNum.length() == 0) {
							bValid = false;
				        	new AlertDialog.Builder(NewNS.this)
...
// ---------------------------------------------------------------------
	...
	protected void onRestoreInstanceState(Bundle savedInstanceState) {
		...
		NewNS.SAVED_BARANGAY = savedInstanceState.getString(this.getString(R.string.Barangay));
		tvMobtel.setText(savedInstanceState.getString(this.getString(R.string.NDSOMobtel)));
		etMobtel.setEnabled(savedInstanceState.getBoolean(MainApp.MOBTEL_ISCHECKED));
	}
// ---------------------------------------------------------------------
	@Override
	protected void onSaveInstanceState(Bundle outState) {
		...
		outState.putString(this.getString(R.string.NDSOMobtel), tvMobtel.getText().toString());
		outState.putBoolean(MainApp.MOBTEL_ISCHECKED, etMobtel.isEnabled());
 ...
 // TODO Main Functions
 // =========================================================================
	protected void sendNSMAP(String sNum) {
		...
		if (etMobtel.isEnabled()){
			//region Old Codes
			/*NSMAP = this.getString(R.string.NSMAP) + " " + etName.getEditableText().toString() + "/" + sSubtypeCode + "/" + etNo.getEditableText().toString()
					  ...
					  + "/" + stockGP.getEditableText().toString() + "," + stockTM.getEditableText().toString() + "," + stockSm.getEditableText().toString() + ","
					  + stockTnT.getEditableText().toString() + "," + stockSun.getEditableText().toString() + "/" + aveReloadGP.getEditableText().toString() + "," + aveReloadTM.getEditableText().toString() + "," 
					  + aveReloadSm.getEditableText().toString() + "," + aveReloadTnT.getEditableText().toString() + "," + aveReloadSun.getEditableText().toString() + "/" + etMobtel.getEditableText().toString() + 
					  "/" + aveSimGP.getEditableText().toString() + "," + aveSimTM.getEditableText().toString() + "," + aveSimSm.getEditableText().toString() + "," + 
					  aveSimTnT.getEditableText().toString() + "," + aveSimSun.getEditableText().toString() + "/" + sInterviewCode + "/" + sInterviewName.getEditableText().toString() 
					  + "/" + sPhone.getEditableText().toString() + "/" + sOwnerName.getEditableText().toString() + "/" + etRemarks.getEditableText().toString();
					  */
			//endregion
			// -- >
			NSMAP001 = this.getString(R.string.NSMAP) + "A "+ txtID + " " + etName.getEditableText().toString() + "/" + sSubtypeCode + "/" + etNo.getEditableText().toString()
					  + "," + etStreet.getEditableText().toString() + "," + ((CodeDescPair)sBarangay.getSelectedItem()).Code + "," + ((CodeDescPair)sCity.getSelectedItem()).Code
					  + "/" + m_maApp.getGPSLong() + "/" +  m_maApp.getGPSLat() + "/" + sStoreSizeCode + "/" + sumList + "/" + sCbMerchPresentString + "/" + sCbMerchDominantString
					  + "/" + stockGP.getEditableText().toString() + "," + stockTM.getEditableText().toString() + "," + stockSm.getEditableText().toString() + ","
					  + stockTnT.getEditableText().toString() + "," + stockSun.getEditableText().toString() + "/" + aveReloadGP.getEditableText().toString() + "," + aveReloadTM.getEditableText().toString() + "," 
			...
			NSMAP002 = this.getString(R.string.NSMAP) + "B "+ txtID + " /" + etMobtel.getEditableText().toString() + "/" + aveSimGP.getEditableText().toString() + "," + aveSimTM.getEditableText().toString() + "," + aveSimSm.getEditableText().toString() + "," + 
					  aveSimTnT.getEditableText().toString() + "," + aveSimSun.getEditableText().toString() + "/" + sInterviewCode + "/" + sInterviewName.getEditableText().toString() 
					  + "/" + sPhone.getEditableText().toString() + "/" + sOwnerName.getEditableText().toString() + "/" + etRemarks.getEditableText().toString();
			...
			/*NSMAP = this.getString(R.string.NSMAP) + " " + etName.getEditableText().toString() + "/" + sSubtypeCode + "/" + etNo.getEditableText().toString()
					  ...
					  + "/" + m_maApp.getGPSLong() + "/" +  m_maApp.getGPSLat() + "/" + sStoreSizeCode + "/" + sumList + "/" + sCbMerchPresentString + "/" + sCbMerchDominantString
					  + "/" + stockGP.getEditableText().toString() + "," + stockTM.getEditableText().toString() + "," + stockSm.getEditableText().toString() + ","
					  + stockTnT.getEditableText().toString() + "," + stockSun.getEditableText().toString() + "/" + aveReloadGP.getEditableText().toString() + "," 
					  + aveReloadTM.getEditableText().toString() + "," + aveReloadSm.getEditableText().toString() + "," + aveReloadTnT.getEditableText().toString() + "," + aveReloadSun.getEditableText().toString() 
					  + "/" + aveSimGP.getEditableText().toString() + "," + aveSimTM.getEditableText().toString() + "," + aveSimSm.getEditableText().toString() + "," + 
					  aveSimTnT.getEditableText().toString() + "," + aveSimSun.getEditableText().toString() + "/" + sInterviewCode + "/" + sInterviewName.getEditableText().toString() 
					  + "/" + sPhone.getEditableText().toString() + "/" + sOwnerName.getEditableText().toString() + "/" + etRemarks.getEditableText().toString(); */
			//endregion
			...
			NSMAP002 = this.getString(R.string.NSMAP) + "B "+ txtID + " /" + aveSimGP.getEditableText().toString() + "," + aveSimTM.getEditableText().toString() + "," + aveSimSm.getEditableText().toString() + "," + 
					  aveSimTnT.getEditableText().toString() + "," + aveSimSun.getEditableText().toString() + "/" + sInterviewCode + "/" + sInterviewName.getEditableText().toString() 
					  + "/" + sPhone.getEditableText().toString() + "/" + sOwnerName.getEditableText().toString() + "/" + etRemarks.getEditableText().toString();
			MainApp.setAndIncrementTextID(this);
		}
		...
		PendingIntent pi = PendingIntent.getBroadcast(NewNS.this, MainApp.REQUEST_ACTION_SENT,  new Intent(this.getPackageName() + MainApp.INTENT_ACTION_SENT), 0);
		
		SmsManager sms = SmsManager.getDefault();
		
		//region Old Codes

		/*ArrayList<String> parts = sms.divideMessage(NSMAP);
		...
		sms.sendTextMessage(sNum, null, NSMAP001, null, null);
		sms.sendTextMessage(sNum, null, NSMAP002, pi, null);
	}
// ---------------------------------------------------------------------
	protected boolean validateFields() {
		...
		if (etMobtel.isEnabled()){
			String sMobtel = etMobtel.getEditableText().toString().trim();
...
// ---------------------------------------------------------------------
	...
	protected void fillBarangays(String code) {
    	...
    	for (CodeDescPair cdp : alBarangays) {
    		aaAdapter.add(cdp);
    		if (cdp.Code.equals(NewNS.SAVED_BARANGAY)) {
    	...
    	if (NewNS.SAVED_BARANGAY.length() > 0) {
			sBarangays.setSelection(iIndex, true);
    	} else {
    		sBarangays.setSelection(iLast, true);
    	}
    	NewNS.SAVED_BARANGAY = ((CodeDescPair)sBarangays.getSelectedItem()).Code;
	}
	// ---------------------------------------------------------------------
    	...
    	if (intent.getAction().equals(this.getPackageName() + MainApp.INTENT_ACTION_SENT)) {
	    	switch (resultCode) {
	    		case Activity.RESULT_OK:
	    			...
	    			cvTemp.put("body", NSMAP001 + NSMAP002);
    		...
    		if (Utility.getDialogResult()) {
    			this.sendNSMAP(m_maApp.getDatabase().getIotaNum());
    		}
    	}
	}
 // =========================================================================
